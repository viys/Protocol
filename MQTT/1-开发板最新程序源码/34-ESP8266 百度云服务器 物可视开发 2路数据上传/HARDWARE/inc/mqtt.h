...
#define  PROJECTID            "zny1rv3"                                     //项目ID
#define  PROJECTID_LEN        strlen(PROJECTID)                             //项目ID长度
#define  DEVICENAME           "data"                                        //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
#define  DEVICESECRE          "9nq2yyzskng40h7y"                            //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                           //设备秘钥长度
#define  S_TOPIC_NAME         "$baidu/iot/shadow/data/update/rejected"      //需要订阅的主题  
#define  P_TOPIC_NAME         "$baidu/iot/shadow/data/update"               //需要发布的主题 
