...
#define  PRODUCTKEY           "a1yT2Yy7KJT"                                        //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                                   //产品ID长度
#define  DEVICENAME           "D001"                                               //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                                   //设备名长度
#define  DEVICESECRE          "7mg6SeQ1N2QGeiJ1ggDFbnvODaqgbW06"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度
#define  S_TOPIC_NAME         "/sys/a1yT2Yy7KJT/D001/thing/service/property/set"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/sys/a1yT2Yy7KJT/D001/thing/event/property/post"    //需要发布的主题  
...
extern char Sign[512];         //外部变量声明，一机一密认证时用的认证信息的缓冲区
extern int  Sign_len;		   //外部变量声明，一机一密认证时用的认证信息数据的长度
